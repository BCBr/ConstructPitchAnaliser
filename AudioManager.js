...
class AudioManager
{
	constructor(runtime, contextOpts)
	{
		...
		/*if (typeof AudioContext !== "undefined")
			audioContext = new AudioContext(contextOpts);
		else if (typeof webkitAudioContext !== "undefined")
			audioContext = new webkitAudioContext(contextOpts);
		else
	...
	decodeAudioData(arrayBuffer, isWebM)
	{
		...
		else
		{
			...
			return this.runtime.assets.decodeWebMOpus(audioContext, arrayBuffer);
		}
	}
